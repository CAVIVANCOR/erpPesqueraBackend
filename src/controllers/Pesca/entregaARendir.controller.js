import entregaARendirService from '../../services/Pesca/entregaARendir.service.js';
...
export async function actualizar(req, res, next) {
  try {
    ...
    const actualizado = await entregaARendirService.actualizar(id, req.body, usuarioId);
